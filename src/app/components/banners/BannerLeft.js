...
export const BannerLeft = ({bannerClass, bannerImage, title, text}) => {

	return (
		<div className={`${bannerClass} relative banner-left flex flex-col sm:flex-row  justify-start`}  >
			<div className="hidden lg:block absolute w-full h-full top-0 left-0 bg-no-repeat bg-right " style={{ backgroundImage: `url('${bannerImage.src}')` }}></div>
